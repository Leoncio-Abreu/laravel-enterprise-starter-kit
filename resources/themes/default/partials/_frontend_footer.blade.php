...
<!--    <script src="js/scripts.js" type="text/javascript"></script>-->
    ...
    /*jQuery(document).ready(function($) {
        ...
        bigbrother = $('.bigbrother').height();

        $('.small-brother').each(function() {
          $('.small-brother').height((bigbrother/2)-103);
        });

        
        var bigbrother2 = -1;

        $('.bigbrother2').each(function() {
            if ($('.bigbrother2').height() > bigbrother2) {
                bigbrother2 = $('.bigbrother2').height();
            }
        });

        $('.bigbrother2').each(function() {
          $('.bigbrother2').height(bigbrother2);
        });
    });*/
